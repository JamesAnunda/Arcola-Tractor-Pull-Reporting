...
export default function FoodPage() {
  ...
  const { data: foodItems, isLoading, isError } = useQuery<InventoryItemWithStatus[]>({
    ...
    <>
      ...
      <div className="flex flex-col h-screen">
        ...
        <div className="flex flex-1 overflow-hidden">
          <Sidebar activeRoute="food" />
          
          <main className="flex-1 overflow-y-auto p-6 bg-neutral-100">
            <div className="mb-6">
              <h2 className="text-2xl font-bold text-secondary">Food Inventory</h2>
              <p className="text-neutral-300">Manage and track your food items</p>
            </div>
            ...
            {isError ? (
              <Alert variant="destructive" className="mb-6">
                ...
                <AlertDescription>
                  There was an error loading the food inventory.
                </AlertDescription>
              </Alert>
            ) : (
                      ...
                      {isLoading ? (
                        ...
                        <TableRow>
                          <TableCell colSpan={6} className="text-center py-8">
                            <p className="text-neutral-300">No food items found</p>
                            {searchQuery && (
